...
/datum/game_mode/vampire
	...
	protected_jobs = list("Chaplain", "NTSF Officer", "NTSF Warden", "NTSF Investigator", "NTSF Commander", "Captain", "Blueshield", "Nanotrasen Representative", "NTSF Pilot", "NTSF Medic", "Internal Affairs Agent", "Nanotrasen Navy Officer", "Special Operations Officer")
	required_players = 15
	required_enemies = 1
