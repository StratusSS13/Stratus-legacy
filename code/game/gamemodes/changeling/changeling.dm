...
/datum/game_mode/changeling
	...
	protected_jobs = list("NTSF Officer", "NTSF Warden", "NTSF Investigator", "NTSF Commander", "Captain", "Blueshield", "Nanotrasen Representative", "NTSF Pilot", "NTSF Medic", "Internal Affairs Agent", "Nanotrasen Navy Officer", "Special Operations Officer")
