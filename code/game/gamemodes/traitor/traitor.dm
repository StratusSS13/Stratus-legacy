...
/datum/game_mode/traitor
	...
	protected_jobs = list("NTSF Officer", "NTSF Warden", "NTSF Investigator", "NTSF Commander", "NTSF Medic", "Captain", "Blueshield", "Nanotrasen Representative", "NTSF Pilot", "Internal Affairs Agent", "Nanotrasen Navy Officer", "Special Operations Officer")
	required_players = 0
	required_enemies = 1
