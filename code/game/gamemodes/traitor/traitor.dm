...
/datum/game_mode/traitor
	...
	protected_jobs = list("Head of Personnel", "Chief Engineer", "Research Director", "Chief Medical Officer", "NTSF Officer", "NTSF Warden", "NTSF Investigator", "NTSF Commander", "NTSF Medic", "Captain", "Blueshield", "Nanotrasen Representative", "NTSF Pilot", "Magistrate", "Internal Affairs Agent", "Nanotrasen Navy Officer", "Special Operations Officer")
	required_players = 0
	required_enemies = 1
