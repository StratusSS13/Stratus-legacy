	...
	spawn(30)
		if(istype(target,/mob/living/carbon))
			if(myeffect == "Borgification")
				...
				command_announcement.Announce("[mytarget] is hereby demoted to the rank of Intern. Process this demotion immediately. Failure to comply with these orders is grounds for termination.","CC Demotion Order")
			else
