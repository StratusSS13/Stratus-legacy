...
/obj/item/clothing/under/rank/security
	name = "\improper Security Officer's jumpsuit"
...
/obj/item/clothing/under/rank/security/skirt
	name = "\improper Security Officer's jumpskirt"
...
/obj/item/clothing/under/rank/security2
	name = "\improper Security Officer's uniform"
...
/obj/item/clothing/under/rank/head_of_security
	...
	name = "\improper Head of Security's jumpsuit"
	icon_state = "hos"
	item_state = "r_suit"
	item_color = "hosred"
	armor = list(melee = 10, bullet = 0, laser = 0, energy = 0, bomb = 0, bio = 0, rad = 0)
...
/obj/item/clothing/under/rank/head_of_security/skirt
	...
	name = "\improper Head of Security's jumpskirt"
	icon_state = "hosredf"
	item_state = "r_suit"
	item_color = "hosredf"
	flags_size = null
...
/obj/item/clothing/under/rank/security/formal
	name = "\improper security formal suit"
...
/obj/item/clothing/under/rank/security/brigphys
	...
	name = "\improper Brig Physician's jumpsuit"
...
/obj/item/clothing/under/rank/security/pod_pilot
	...
	name = "\improper security pilot's jumpsuit"
