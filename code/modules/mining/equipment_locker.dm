...
/obj/machinery/mineral/ore_redemption
	...
	var/list/supply_consoles = list("Science", "Robotics", "Research Director's Desk", "Explorer", "Engineering" = list("metal", "glass", "plasma"), "Chief Engineer's Desk" = list("metal", "glass", "plasma"), "Atmospherics" = list("metal", "glass", "plasma"), "Bar" = list("uranium", "plasma"), "Virology" = list("plasma", "uranium", "gold"))
	speed_process = 1
